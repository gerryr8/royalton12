        ...
        <div class="row">
                ...
                <form action="test.php" id="form" method="post">
                    <div class=" row mb-3">
                        ...
                        <select class="form-select " id="departamentos" name="departamento" required style="width:500px">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="nombre" class="form-label" style="width:500px">Last names</label>
                            <input type="text" class="form-control" id="nombre" name="nombres" required>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="puesto" class="form-label" style="width:500px">Position</label>
                                <input type="text" class="form-control" id="puesto" name="puesto" required>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="numerodealfitrion" class="form-label" style="width:500px">N° host</label>
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="row mb-3">
                                                                                ...
                                                                                <div class="row mb-3">
                                                                                    ...
                                                                                    <button type="submit" class="btn btn-success" id="send" style="width:500px">Enviar</button>
